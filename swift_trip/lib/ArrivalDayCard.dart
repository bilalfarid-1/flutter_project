      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text("Arrival Day", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              SizedBox(height: 8),
              Text("From: Lahore"),
              Text("Travel Time: 10 hrs"),
              Text("Arrival Time: Around 6 PM"),
              SizedBox(height: 8),
              Text("Meals: Dinner", style: TextStyle(fontWeight: FontWeight.w600)),
              SizedBox(height: 12),
              ...
              accommodationTile("Luxury Palace", "Rs. 25,000/night", 4.9, false),
            ],
          ),
        ),
      ),
